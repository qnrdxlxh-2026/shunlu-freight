...
Page({
  ...
  goPublishRoute() {
    wx.navigateTo({ url: '/pages/publish-route/publish-route' });
  },

  goFindGoods() {
    wx.navigateTo({ url: '/pages/find-goods/find-goods' });
  },

  goMyRoutes() {
    wx.navigateTo({ url: '/pages/my-routes/my-routes' });
  },
  ...
  goOrders(e) {
    ...
    wx.navigateTo({ url: '/pages/orders/orders' + (status ? '?status=' + status : '') });
  },
